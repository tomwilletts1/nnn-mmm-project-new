...
if emb_df is not None:
    ...
    embedding_cols = [col for col in emb_df.columns if col.isdigit() or col.isnumeric()]
else:
    embedding_cols = []
...
all_features = default_features + embedding_cols
feature_cols = st.sidebar.multiselect(
    "Select features for modeling",
    options=all_features,
    default=default_features + embedding_cols[:8],
